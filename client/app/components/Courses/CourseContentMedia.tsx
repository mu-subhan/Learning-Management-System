...
import { useAddAnswerInQuestionMutation, useAddnewQuestionMutation, useGetCourseDetailsQuery } from '@/redux/features/courses/courseApi';
...
const CourseContentMedia = ({ data, id, activeVideo, setActiveVideo, user, refetch }: Props) => {
    ...
    }, [questionSuccess, error, answerSuccess, answerError, refetch]);
