  ...
  return (
    <div>
      {options.map((option, index) => (
        <div
          key={index}
          className={`w-full m-[13px] md:m-[0px] md:flex py-5`}
        ...
        >
          ...
          >
            ...
            {index !== options.length - 1 && (
              <>
                <div
                  className={`absolute hidden md:block h-[65px] w-1   ${
                    active + 1 > index ? "bg-blue-500" : "bg-[#384766]"
                  } bottom-[-150%]  `}
                />
                <div
                  className={`absolute md:hidden h-[2px]  w-[60px] ${
                    active + 1 > index ? "bg-blue-500" : "bg-[#384766]"
